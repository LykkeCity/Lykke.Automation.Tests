...
namespace Lykke.Client.AutorestClient.Models
{
    ...
    public partial class CashoutSwiftLastDataResponse
    {
        ...
        /// class.
        /// </summary>
        public CashoutSwiftLastDataResponse(string bic = default(string), string accNumber = default(string), string accName = default(string), string bankName = default(string), string accHolderAddress = default(string), string accHolderCity = default(string), string accHolderCountry = default(string), string accHolderZipCode = default(string))
        {
            Bic = bic;
            AccNumber = accNumber;
            AccName = accName;
