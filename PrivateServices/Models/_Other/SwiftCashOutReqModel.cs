...
namespace Lykke.Client.AutorestClient.Models
{
    ...
    public partial class SwiftCashOutReqModel
    {
        /// <summary>
        /// Initializes a new instance of the SwiftCashOutReqModel class.
        /// </summary>
        public SwiftCashOutReqModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the SwiftCashOutReqModel class.
        /// </summary>
        public SwiftCashOutReqModel(string assetId = default(string), double? amount = default(double?), string bic = default(string), string accNumber = default(string), string accName = default(string), string accHolderAddress = default(string), string bankName = default(string), string accHolderCountry = default(string), string accHolderZipCode = default(string), string accHolderCity = default(string), string correspondentAccount = default(string))
        {
            AssetId = assetId;
            Amount = amount;
            Bic = bic;
