...
namespace Lykke.Client.AutorestClient.Models
{
    ...
    public partial class OffchainFinalizeModel
    {
        ...
        /// Initializes a new instance of the OffchainFinalizeModel class.
        /// </summary>
        public OffchainFinalizeModel(string transferId = default(string), string clientRevokePubKey = default(string), string clientRevokeEncryptedPrivateKey = default(string), string signedTransferTransaction = default(string))
        {
