...
namespace Lykke.Client.ApiV2.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the AssetPairRateModel class.
        /// </summary>
        public AssetPairRateModel()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the AssetPairRateModel class.
        /// </summary>
        public AssetPairRateModel(string assetPair, double bidPrice, double askPrice, System.DateTime bidPriceTimestamp, System.DateTime askPriceTimestamp)
        {
            AssetPair = assetPair;
            BidPrice = bidPrice;
            AskPrice = askPrice;
